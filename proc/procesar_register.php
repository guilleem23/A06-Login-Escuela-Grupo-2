...
// 4.1. Campos vacíos
if (empty($nom) || empty($username) || empty($email) || empty($password) || empty($password_confirm)) {
...
try {
    ...
    $sql_insert = "INSERT INTO tbl_usuari (nom, username, email, password, tipusUsuari) 
                   VALUES (:nom, :username, :email, :password, 3)";
